...
CLASS ltc_sales_orders_report IMPLEMENTATION.
  ...
  METHOD setup.
    BREAK-POINT. "Auto-inserted: Manipolazione dati
  ...
  METHOD test_orders_with_positions.
    ...
    BREAK-POINT. "Auto-inserted: Inizio di un ciclo
